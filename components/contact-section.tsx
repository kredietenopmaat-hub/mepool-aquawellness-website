...
const contactInfo = [
  ...
  },
  {
    icon: MapPin,
    label: "Adres",
    value: "Wellness Straat 123, 2000 Antwerpen",
    href: "#",
  },
  {
    icon: Clock,
    label: "Openingsuren",
    value: "Ma-Vr: 8:00-18:00 | Za: 9:00-13:00",
    href: "#",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground text-pretty">
            Neem contact met ons op voor een vrijblijvende offerte of advies. Wij staan klaar om u te helpen.
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Heeft u vragen over onze diensten of wilt u een afspraak maken? Neem gerust contact met ons op via onderstaande gegevens.
              </p>
            </div>
